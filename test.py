...
def respond_synonyms(user_text, output_count = 3):
    ...
    output = urlrequest.urlopen('https://api.datamuse.com/words?ml=' + input_string + '&max=' + str(output_count)).read()
...
def respond_meaning(user_text):
    ...
    output = urlrequest.urlopen('https://api.datamuse.com/words?sp=' + input_string + '&md=d&max=1').read()
